...
const SidebarRestaurant: React.FC<Props> = (props) => {
    ...
    const Menus = [
        ...
        // { title: "Dashboard", href: "dashboard", spacing: true, icon: <RiDashboardFill /> },
        { title: "Edit Profile", href: "editProfile", icon: <FaRegEdit /> },
        { title: "Gallery", href: "gallery", icon: <TfiGallery /> },
        { title: "Food Menu", href: "foodMenu", icon: <BiFoodMenu /> },
