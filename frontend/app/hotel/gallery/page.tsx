...
const HotelGalleryPage: React.FC = () => {
    ...
    const deleteImage = async (item: string) => {
        ...
        const res = await fetch("http://localhost:4000/hotel/deleteImage", {
            method: "POST",
            body: formData,
            credentials: "include",
        });
    ...
    const setAsDp = async (item: string) => {
        ...
        const res = await fetch("http://localhost:4000/hotel/setAsDp", {
            method: "POST",
            body: formData,
            credentials: "include",
        });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await fetch("http://localhost:4000/hotel/uploadImage", {
            method: "POST",
            body: formData,
            credentials: "include",
        });
