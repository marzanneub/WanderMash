...
const HotelGalleryPage: React.FC = () => {
    ...
    const deleteImage = async (item: string) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_SERVER_URL}/hotel/deleteImage`, {
            method: "POST",
            body: formData,
            credentials: "include",
        });
    ...
    const setAsDp = async (item: string) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_SERVER_URL}/hotel/setAsDp`, {
            method: "POST",
            body: formData,
            credentials: "include",
        });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_SERVER_URL}/hotel/uploadImage`, {
            method: "POST",
            body: formData,
            credentials: "include",
        });
                        ...
                        <div className="mt-10 bg-white p-6 rounded-2xl shadow-md">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                                <div className="relative group">
                                    <img src={`${process.env.NEXT_PUBLIC_BACKEND_SERVER_URL}BLIC_BACKEND_SERVER_URL}/images/${user.dp}`} alt="Gallery Image" className="w-full h-48 object-cover rounded-xl shadow-md" />
                                ...
                                {images.map((item) => (item !== user.dp && (
                                    <div key={item} className="relative group w-full h-auto">
                                        <img src={`${process.env.NEXT_PUBLIC_BACKEND_SERVER_URL}BLIC_BACKEND_SERVER_URL}/images/${item}`} alt="Gallery Image" className="w-full h-full object-cover rounded-xl shadow-md" />
