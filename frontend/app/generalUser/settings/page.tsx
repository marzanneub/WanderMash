...
const GeneralUserSettingsPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if(password.length || newPassword.length || confirmPassword.length) {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_SERVER_URL}/generalUser/settings`, {
                method: "POST",
                headers: {
            ...
            if(!res.ok){
                ...
                const msg = "Current password is invalid";
    ...
    return (
        <div className="bg-indigo-50 min-h-screen w-full flex">
            <SidebarGeneralUser pagetype="Settings" />
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button type="submit"
                                    className="px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold border bg-indigo-600 rounded-md shadow-md transition cursor-pointer">
                                    Save Settings
                                </button>
                            </div>
                        </div>
