...
const AdminHotelsPage: React.FC = () => {
    ...
    const handleApprove = async (_id: string) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_SERVER_URL}/admin/approveHotel`, {
            method: "POST",
            body: formData,
            credentials: "include",
        });
    ...
    const handleDisapprove = async (_id: string) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_SERVER_URL}/admin/disapproveHotel`, {
            method: "POST",
            body: formData,
            credentials: "include",
        });
    ...
    return (
        <div className="bg-indigo-50 min-h-screen w-full flex">
            ...
            <main className="container mx-auto px-10 py-16 max-w-7xl">
                <h1 className="text-4xl font-bold text-indigo-900 mb-10">Hotels</h1>
                ...
                {!loading && (
                    <div className="grid grid-cols-1 gap-10 items-start">
                        ...
                        <div className="space-y-5">
                            ...
                            {(hotels && hotels.length>0) ? (hotels.map((item, index) => (
                                <div key={index} className="bg-white p-5 rounded-2xl border flex gap-5 shadow-sm transition-all border-slate-200">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex gap-4 mt-4 pt-3 border-t border-slate-50">
                                            ...
                                            <Link
                                            href={`/hotels/preview?id=${item._id}`}
                            ...
                            <div className="bg-white border-2 border-dashed border-slate-200 rounded-3xl p-16 text-center">
                                <h3 className="text-xl font-bold text-slate-700">No hotels found</h3>
                            </div>
                            )}
                        </div>
