...
const TourismManagerSettingsPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if(password.length || newPassword.length || confirmPassword.length) {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_SERVER_URL}/tourismManager/settings`, {
                method: "POST",
                headers: {
    ...
    return (
        <div className="bg-indigo-50 min-h-screen w-full flex">
            <SidebarTourismManager pagetype="Settings" />
...
export default TourismManagerSettingsPage;